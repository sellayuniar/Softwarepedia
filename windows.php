...
$data = mysqli_query($koneksi, "select * from tb_artikel where status = 'verified' and kategori_artikel = 'windows' order by id_artikel DESC"); //membuat variabel $data yang menyimpan query untuk menyeleksi data dari tb_artikel yang statusnya verified dan kategori artikel windows diurutkan dari angka id_artikel terbesar
?> 
                    ...
                    <div class="col-8">  <!--membuat kolom dengan ukuran 8  -->
                        ...
                        <h2 class="card-title"><?php echo $data_artikel['judul_artikel'] ?></h2>  <!-- menampikan data judul artikel -->
                         ...
                         <div class="small text-muted"> <!-- membuat tampilan text -->
                            ...
                            <h6>
                                <span class="badge bg-secondary" style="20px">
