    ...
    <div class="col-md-4"> <!-- membuat tampilan layar medium  -->
      <div class="card"> <!--membuat tampilan card -->
        <div class="card-header bg-transparent mb-0"> <!--membuat tampilan card-header dengan background transparan dan margin bottom 0 -->
          ...
          <h3 class="text-center"> <i class="bi bi-person-circle"></i> User <span class="font-weight-bold text-primary">LOGIN</span></h3> <!--membuat text login -->
        </div>
        </div>
        <div class="card-body"> <!--membuat card-body untuk tampilan isi form login -->
          <form action="proses_login_pengguna.php" method="POST"> <!--membuat form dengan method post dan ketika file di submit akan mengeksekusi halaman proses_login_pengguna.php -->
