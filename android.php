...
$data = mysqli_query($koneksi, "select * from tb_artikel where status = 'verified' and kategori_artikel = 'android' order by id_artikel DESC"); //membuat variabel $data yang menyimpan query untuk menyeleksi data dari tb_artikel ketika statusnya verified dan kategori artikel android diurutkan dari angka id_artikel terbesar
?>
            ...
            <div class="card-body">  <!-- membuat tampilan card-body -->
                <div class="row">  <!-- membuat baris -->
                    <div class="col-4">  <!-- membuat kolom dengan ukuran 4 -->
                        ...
                        ?>
                            <img src="../image/<?php echo $data_artikel['gambar'] ?>" width="100%" />
                        <?php
                        } ?>
                    </div>
                    <div class="col-8">  <!--membuat kolom dengan ukuran 8  -->
                        ...
                        <h2 class="card-title"><?php echo $data_artikel['judul_artikel'] ?></h2>  <!-- menampikan data judul artikel -->
                         ...
                         Penulis <?php //menampilkan data user yang membuat artikel
                            ...
                            <h6>
                                <span class="badge bg-danger" style="20px">
