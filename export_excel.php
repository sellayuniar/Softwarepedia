...
<head>
    <title>Softwarepedia</title> <!-- judul website -->
</head>
...
<body>
    ...
    <?php
    header("Content-type: application/vnd-ms-excel"); //untuk menggenerate file excel
    header("Content-Disposition: attachment; filename=Rating.xls"); //untuk memberi name file excel
        ...
        ?>
            <tr>
                ...
                while ($dataartikeldislike = mysqli_fetch_assoc($sqlartikeldislike)) { //perulangan untuk menampilkan data
                    if ($dataartikeldislike['id_artikel'] == $id_artikeldislike) { //jika id_artikel sama dengan id_artikel_dislike
                ?>
...
<!-- untuk mengeluarkan output buffer -->
<?php ob_flush(); ?>